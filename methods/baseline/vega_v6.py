"""
VEGA Optimized V6: Visual-Textual Graph Alignment with Mathematical Corrections
...
V6 说明:
- 核心算法与 v2 保持一致。
- v6 的实验差异由上游脚本控制，使用 caption_text_feat 作为文本特征来源。
...
- 2026-03-13: 创建 v6 文件，保持算法不变用于 caption_text_feat 实验
"""
